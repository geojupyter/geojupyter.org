...
I also added support for multiple
[dynamic tiling](https://developmentseed.org/titiler/user_guide/dynamic_tiling)
backends (currently, TiTiler and Xpublish).
...
jupyter-tiler provides an engine for loading map tiles dynamically from xarray `Dataset`s
for real-time display on interactive maps.
