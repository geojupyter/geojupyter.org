...
jupyter-tiler works under the hood, and it's intended for use by authors of
Jupyter interactive map widgets, like
[ipyleaflet](https://github.com/jupyter-widgets/ipyleaflet),
[ipyopenlayers](https://github.com/geojupyter/ipyopenlayers), and JupyterGIS,
to enable them to provide their users with convenient features that leverage a
dynamic tile server.
