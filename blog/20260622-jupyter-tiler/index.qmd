...
mamba install \
  ...
  --channel conda-forge \
  jupytergis-tiler==0.16.0a4
```

## pip

```bash
pip install --pre jupytergis[tiler]==0.16.0a4
```
:::

:::{.callout-note}
At time of writing, JupyterGIS' latest prerelease is `0.16.0a4`, and jupyter-tiler's latest
release is `0.8.0`.
:::
